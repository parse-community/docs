...
3. Create an Atlas account. After that, create your cluster and a Database. Then create a new application connection and then copy the database connection string(URI).
