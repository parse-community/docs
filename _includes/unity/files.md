...
You can delete files that are referenced by objects using the [REST API]({{ site.baseUrl }}/rest/guide/#files-deleting). You will need to provide the master key in order to be allowed to delete a file.
