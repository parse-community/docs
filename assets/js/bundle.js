...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (UI, _) {
		...
		AppsList.prototype = {
			render: function render() {
				...
				$('code.hljs').each(function (i, el) {
					...
					if (match !== null) {
						...
						el.innerHTML = el.innerHTML.replace('${APPLICATION_ID}', '<span class="application_id">' + app.applicationId + '</span>').replace('${REST_API_KEY}', '<span class="rest_key">' + app.restKey + '</span>').replace('${MASTER_KEY}', '<span class="master_key">' + app.masterKey + '</span>').replace('${CLIENT_KEY}', '<span class="client_key">' + app.clientKey + '</span>');
						new UI.Dropdown({
			...
			handleDropdownChange: function handleDropdownChange(val, dd) {
